...
local GUILD_ROSTER_STORM_RANDOM_DELAY_RANGE = {60, 180}  -- Random delay range (seconds) for roster-triggered manifests
local GUILD_ROSTER_MIN_INTERVAL = 300  -- Min seconds between roster-triggered manifests
local MANIFEST_DEBOUNCE_SECONDS = 2  -- Debounce time for manifest broadcasts (coalescing rapid events)
local MANIFEST_HEARTBEAT_INTERVAL = 3600 -- Send manifest every 60 minutes if no other activity
