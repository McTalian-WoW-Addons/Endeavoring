...
_G.CreateFrame = _G.CreateFrame
	or function(frameType, name, parent, template)
		local frame = {
		...
		function frame:GetPoint(index)
			return unpack(self._points[index or 1] or {})
		end
...
_G.TabSystemOwnerMixin = _G.TabSystemOwnerMixin
	or {
		OnLoad = function() end,
		SetTabSystem = function() end,
		AddNamedTab = function()
			return 1
		end,
		SetTab = function() end,
	}
